...
login_data = [
    ...
    {'Role': 'Anggota', 'UserID': 'AP01', 'Username': 'Amin', 'Pass': 'Aminz'},
    {'Role': 'Anggota', 'UserID': 'AP02', 'Username': 'Zakaria', 'Pass': 'Test'}
]
...
def menu_admin():
    ...
    while True:
        ...
        if pilihan == '1':
            ...
            if keluar == 1 :
                print(f"Terima kasih dan sampai jumpa, {username}!\n-\n-\n-\n-.")
                exit()
            elif keluar == 2 :
                main()
            else: 
...
def tambah_alat(nama_alat):
    ...
    tampilkan_alat()
    print(f"Alat berhasil ditambahkan pada No {no_baru}.")
...
def tambah_anggota(username):
    ...
    if role == 'Admin' or role == 'Anggota' :
        ...
        return 
    print("Role yang diinput tidak sesuai. Role harus diisi 'Admin' atau 'Anggota'")
